...
export function Research() {
  ...
  const projects = [
    ...
    },
    {
      ...
      duration: "7 weeks",
      category: "Mobility",
      description: "Exploring the future of urban commuting through the design of a compact VTOL vehicle, using traditional sketching and VR-based ideation tools to develop contextually relevant exterior design concepts.",
