import svgPaths from "./svg-1jcepi9617";
...
function Container() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[1024px]" data-name="Container">
      <p className="-translate-x-1/2 absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-[512.99px] text-[#f60] text-[14px] text-center top-[1.5px] tracking-[0.5496px] uppercase whitespace-nowrap">Our Mission</p>
    </div>
  );
}
...
function H1() {
  return (
    <div className="absolute h-[48px] left-0 top-0 w-[1024px]" data-name="h2">
      <p className="-translate-x-1/2 absolute font-['Manrope:Medium',sans-serif] font-medium leading-[48px] left-[512.17px] text-[#003153] text-[48px] text-center top-[0.5px] tracking-[0.3516px] whitespace-nowrap">What We Believe In</p>
    </div>
  );
}
...
function P() {
  return (
    <div className="h-[39px] relative shrink-0 w-full" data-name="p">
      <div className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[0] left-[512.49px] not-italic text-[#003153] text-[0px] text-center top-[0.5px] tracking-[0.0703px] whitespace-nowrap">
        <p className="font-['Manrope:Medium',sans-serif] leading-[39px] mb-0 text-[20px]">Design for Future (DeF) lab is envisioned to create visions for new design solutions</p>
        <p className="font-['Manrope:Medium',sans-serif] mb-0 text-[20px]">
        ...
        <p className="font-['Manrope:Medium',sans-serif] leading-[39px] text-[20px]">of new transforming India through design innovation and active research.</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[0.5px] top-[116px] w-[1024px]" data-name="Container">
      <P />
    </div>
  );
}
...
function Container6() {
  return (
    <div className="absolute h-[24px] left-0 top-[49px] w-[494.5px]" data-name="Container">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#f60] text-[18px] top-[2px] tracking-[0.5496px] uppercase w-[164px]">About DeF Lab</p>
    </div>
  );
}
...
function H2() {
  return (
    <div className="-translate-y-1/2 absolute h-[75px] left-0 top-1/2 w-[494.5px]" data-name="h2">
      <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[75px] left-0 text-[#f60] text-[63px] top-0 tracking-[0.2637px] w-[417px]">Who We Are?</p>
    </div>
  );
}
...
function P1() {
  return (
    <div className="h-[87.75px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[0.5px] not-italic text-[#666] text-[0px] top-[-8.25px] tracking-[-0.4395px] w-[476px]">
        <span className="font-['Manrope:Regular',sans-serif] leading-[29.25px] text-[20px]">{`We are dedicated to `}</span>
        <span className="font-['Manrope:Medium',sans-serif] font-medium leading-[29.25px] text-[#003153] text-[20px]">exploring and experimenting</span>
        <span className="font-['Manrope:Regular',sans-serif] leading-[29.25px] text-[20px]">{` with new mobility and automotive solutions through the synthesis of design and research.`}</span>
      </p>
    </div>
  );
}
...
function P2() {
  return (
    <div className="h-[87.75px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[0.5px] not-italic text-[#666] text-[0px] top-[-8.25px] tracking-[-0.4395px] w-[482px]">
        <span className="font-['Manrope:Regular',sans-serif] leading-[29.25px] text-[20px]">{`DeF lab provides comprehensive support to designers and researchers to `}</span>
        <span className="font-['Manrope:Medium',sans-serif] font-medium leading-[29.25px] text-[#003153] text-[20px]">envision, conceptualize, create, digitize</span>
        <span className="font-['Manrope:Regular',sans-serif] leading-[29.25px] text-[20px]">{`, and `}</span>
        <span className="font-['Manrope:Medium',sans-serif] font-medium leading-[29.25px] text-[#003153] text-[20px]">simulate creative ideas</span>
        <span className="font-['Manrope:Regular',sans-serif] leading-[29.25px] text-[20px]">.</span>
      </p>
    </div>
  );
}
...
function P3() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[24px] left-0 text-[#003153] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Digital Prototyping</p>
    </div>
  );
}
...
function P4() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] w-[175px]">Transforming physical concepts into digital reality</p>
    </div>
  );
}
...
function P5() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[24px] left-0 text-[#003153] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Emerging Technologies</p>
    </div>
  );
}
...
function P6() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] w-[159px]">Integrating cutting-edge tools and methods</p>
    </div>
  );
}
...
function P7() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[24px] left-0 text-[#003153] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Creative Visualization</p>
    </div>
  );
}
...
function P8() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] w-[187px]">Bringing innovative concepts to life</p>
    </div>
  );
}
...
function P9() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[24px] left-0 text-[#003153] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Future Empowerment</p>
    </div>
  );
}
...
function P10() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] w-[172px]">Preparing next-gen designers and researchers</p>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="-translate-x-1/2 absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-[518.84px] text-[#f60] text-[14px] text-center top-[1.5px] tracking-[0.5496px] uppercase whitespace-nowrap">What We Do</p>
    </div>
  );
}
...
function H3() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="h2">
      <p className="-translate-x-1/2 absolute font-['Manrope:Medium',sans-serif] font-medium leading-[40px] left-[518.73px] text-[#003153] text-[36px] text-center top-[0.5px] tracking-[0.3691px] whitespace-nowrap">DeF lab offers three main facilities</p>
    </div>
  );
}
...
function H4() {
  return (
    <div className="absolute h-[56px] left-[32px] top-[80px] w-[258.328px]" data-name="h3">
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[28px] left-0 text-[#003153] text-[20px] top-0 tracking-[-0.4492px] w-[233px]">Design for Future concept generation</p>
    </div>
  );
}
...
function P11() {
  return (
    <div className="absolute h-[72px] left-[32px] top-[148px] w-[258.328px]" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#666] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[225px]">Creating innovative visions and concepts for future design solutions</p>
    </div>
  );
}
...
function H5() {
  return (
    <div className="absolute h-[56px] left-[32px] top-[80px] w-[258.336px]" data-name="h3">
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[28px] left-0 text-[#003153] text-[20px] top-0 tracking-[-0.4492px] w-[202px]">Digitisation of physical artefacts</p>
    </div>
  );
}
...
function P12() {
  return (
    <div className="absolute h-[72px] left-[32px] top-[148px] w-[258.336px]" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#666] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[232px]">Converting physical objects into digital formats for analysis and preservation</p>
    </div>
  );
}
...
function H6() {
  return (
    <div className="absolute h-[56px] left-[32px] top-[80px] w-[258.336px]" data-name="h3">
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[28px] left-0 text-[#003153] text-[20px] top-0 tracking-[-0.4492px] w-[196px]">Digital visualisation of creative concepts</p>
    </div>
  );
}
...
function P13() {
  return (
    <div className="absolute h-[72px] left-[32px] top-[148px] w-[258.336px]" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#666] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[225px]">Bringing creative ideas to life through advanced visualization techniques</p>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="absolute h-[24px] left-0 top-0 w-[1037px]" data-name="Container">
      <p className="-translate-x-1/2 absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-[519.09px] text-[#f60] text-[14px] text-center top-[1.5px] tracking-[0.5496px] uppercase whitespace-nowrap">Gallery</p>
    </div>
  );
}
...
function H7() {
  return (
    <div className="absolute h-[40px] left-0 top-[40px] w-[1037px]" data-name="h2">
      <p className="-translate-x-1/2 absolute font-['Manrope:Medium',sans-serif] font-medium leading-[40px] left-[519.44px] text-[#003153] text-[36px] text-center top-[0.5px] tracking-[0.3691px] whitespace-nowrap">Lab in Action</p>
    </div>
  );
}
...
function P14() {
  return (
    <div className="absolute h-[28px] left-0 top-[96px] w-[1037px]" data-name="p">
      <p className="-translate-x-1/2 absolute font-['Manrope:Regular',sans-serif] font-normal leading-[28px] left-[518.94px] text-[#666] text-[18px] text-center top-0 tracking-[-0.4395px] whitespace-nowrap">Glimpses from our research and innovation space</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="-translate-x-1/2 absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-[518.98px] text-[#f60] text-[14px] text-center top-[1.5px] tracking-[0.5496px] uppercase whitespace-nowrap">{`News & Updates`}</p>
    </div>
  );
}
...
function H8() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="h2">
      <p className="-translate-x-1/2 absolute font-['Manrope:Medium',sans-serif] font-medium leading-[40px] left-[518.51px] text-[#003153] text-[36px] text-center top-[0.5px] tracking-[0.3691px] whitespace-nowrap">Latest Happenings</p>
    </div>
  );
}
...
function P15() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="p">
      <p className="-translate-x-1/2 absolute font-['Manrope:Regular',sans-serif] font-normal leading-[28px] left-[518.48px] text-[#666] text-[18px] text-center top-0 tracking-[-0.4395px] whitespace-nowrap">Stay updated with our recent activities and achievements</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,102,0,0.1)] h-[24px] relative rounded-[16777200px] shrink-0 w-[79.219px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[16px] left-[12px] text-[#f60] text-[12px] top-[5px] tracking-[0.6px] whitespace-nowrap">Facilities</p>
      </div>
    </div>
  );
}
...
function Span1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[94.047px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">March 5, 2026</p>
      </div>
    </div>
  );
}
...
function H9() {
  return (
    <div className="absolute h-[56px] left-[24px] top-[64px] w-[274.328px]" data-name="h3">
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[28px] left-0 text-[#003153] text-[20px] top-[0.14px] tracking-[-0.4492px] w-[238px]">New VR Equipment Installation Completed</p>
    </div>
  );
}
...
function P16() {
  return (
    <div className="absolute h-[72px] left-[24px] top-[132px] w-[274.328px]" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#666] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[241px]">State-of-the-art VR systems now operational for immersive design research</p>
    </div>
  );
}
...
function Span2() {
  return (
    <div className="bg-[rgba(255,102,0,0.1)] h-[24px] relative rounded-[16777200px] shrink-0 w-[81.25px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[16px] left-[12px] text-[#f60] text-[12px] top-[5px] tracking-[0.6px] whitespace-nowrap">Research</p>
      </div>
    </div>
  );
}
...
function Span3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[119.859px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">February 28, 2026</p>
      </div>
    </div>
  );
}
...
function H10() {
  return (
    <div className="absolute h-[56px] left-[24px] top-[64px] w-[274.336px]" data-name="h3">
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[28px] left-0 text-[#003153] text-[20px] top-0 tracking-[-0.4492px] w-[255px]">Research Paper Published in Design Journal</p>
    </div>
  );
}
...
function P17() {
  return (
    <div className="absolute h-[72px] left-[24px] top-[132px] w-[274.336px]" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#666] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[269px]">Our work on future mobility concepts featured in leading international journal</p>
    </div>
  );
}
...
function Span5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[119.664px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">February 20, 2026</p>
      </div>
    </div>
  );
}
...
function H11() {
  return (
    <div className="absolute h-[56px] left-[24px] top-[64px] w-[274.336px]" data-name="h3">
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[28px] left-0 text-[#003153] text-[20px] top-0 tracking-[-0.4492px] w-[180px]">Workshop on Digital Prototyping</p>
    </div>
  );
}
...
function P18() {
  return (
    <div className="absolute h-[72px] left-[24px] top-[132px] w-[274.336px]" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#666] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[237px]">Successful completion of 3-day intensive workshop with industry experts</p>
    </div>
  );
}
...
function Link() {
  return (
    <div className="absolute h-[24px] left-[451.7px] top-[530px] w-[197.594px]" data-name="Link">
      <p className="-translate-x-1/2 absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-[85px] text-[#f60] text-[16px] text-center top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">{`View All News & Events`}</p>
      <ArrowRight />
    </div>
  );
}
...
function Span6() {
  return (
    <div className="absolute bg-[rgba(125,249,255,0.2)] content-stretch flex h-[32.5px] items-start left-0 px-[16px] py-[8px] rounded-[16777200px] top-[-3.5px] w-[216.938px]" data-name="span">
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#003153] text-[14px] tracking-[0.5496px] whitespace-nowrap">DESIGN FOR FUTURE LAB</p>
    </div>
  );
}
...
function H() {
  return (
    <div className="absolute h-[300px] left-0 top-[56px] w-[494.5px]" data-name="h1">
      <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[78.75px] left-0 text-[#003153] text-[63px] top-px tracking-[0.2769px] w-[466.2px]">{`Designing Future Mobility & Immersive Innovation`}</p>
    </div>
  );
}
...
function P19() {
  return (
    <div className="absolute h-[56px] left-0 top-[388px] w-[494.5px]" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[28px] left-0 text-[#666] text-[20px] top-0 tracking-[-0.4395px] w-[529px]">A research space exploring VR, immersive simulations, digital prototyping, and future mobility design at IIT Bombay.</p>
    </div>
  );
}
...
function Link1() {
  return (
    <div className="absolute bg-[#f60] h-[52px] left-0 rounded-[10px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] top-0 w-[201.617px]" data-name="Link">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[16px] text-white top-[13.5px] tracking-[-0.3125px] whitespace-nowrap">Explore Research</p>
      <ArrowRight1 />
    </div>
  );
}
...
function Link2() {
  return (
    <div className="absolute bg-white border-2 border-[#003153] border-solid h-[52px] left-[217.62px] rounded-[10px] top-0 w-[142.305px]" data-name="Link">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#003153] text-[16px] top-[11.5px] tracking-[-0.3125px] whitespace-nowrap">Visit Lab</p>
      <ArrowRight2 />
    </div>
  );
}
...
function P20() {
  return (
    <div className="absolute h-[40px] left-0 top-[64px] w-[324.328px]" data-name="p">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#d1d5dc] text-[14px] top-[0.5px] tracking-[-0.1504px] w-[310px]">Design for Future Lab - Exploring VR, immersive simulations, and future mobility design.</p>
    </div>
  );
}
...
function H12() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="h3">
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[28px] left-0 text-[18px] text-white top-0 tracking-[-0.4395px] whitespace-nowrap">Quick Links</p>
    </div>
  );
}
...
function Link3() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Link">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#d1d5dc] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">About</p>
    </div>
  );
}
...
function Link4() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Link">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#d1d5dc] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Team</p>
    </div>
  );
}
...
function Link5() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Link">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#d1d5dc] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Research</p>
    </div>
  );
}
...
function Link6() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Link">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#d1d5dc] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Contact</p>
    </div>
  );
}
...
function H13() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="h3">
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[28px] left-0 text-[18px] text-white top-0 tracking-[-0.4395px] whitespace-nowrap">Contact Us</p>
    </div>
  );
}
...
function Span8() {
  return (
    <div className="absolute h-[20px] left-[24px] top-0 w-[116.367px]" data-name="span">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#d1d5dc] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">+91 98648 01504</p>
    </div>
  );
}
...
function Span9() {
  return (
    <div className="absolute h-[20px] left-[24px] top-0 w-[237.234px]" data-name="span">
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#d1d5dc] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">DeF Lab, IIT Bombay, Powai, Mumbai</p>
    </div>
  );
}
...
function Link7() {
  return (
    <div className="h-[20px] relative shrink-0 w-[38.813px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">About</p>
      </div>
    </div>
  );
}
...
function Link8() {
  return (
    <div className="h-[20px] relative shrink-0 w-[34.813px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Team</p>
      </div>
    </div>
  );
}
...
function Link9() {
  return (
    <div className="h-[20px] relative shrink-0 w-[55.922px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Facilities</p>
      </div>
    </div>
  );
}
...
function Link10() {
  return (
    <div className="h-[20px] relative shrink-0 w-[53.266px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Courses</p>
      </div>
    </div>
  );
}
...
function Link11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[59.992px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Research</p>
      </div>
    </div>
  );
}
...
function Link12() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Workshops</p>
      </div>
    </div>
  );
}
...
function Link13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[43.203px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Events</p>
      </div>
    </div>
  );
}
...
function Link14() {
  return (
    <div className="h-[20px] relative shrink-0 w-[51.281px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[20px] left-0 text-[#666] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Contact</p>
      </div>
    </div>
  );
}
