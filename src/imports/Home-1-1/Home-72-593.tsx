...
import imgGrad2 from "../gradient_tracking_2.webp";
import imgGrad3 from "../gradient_tracking_3.webp";
...
function Container36() {
  const row1imgs = [imgImg, imgImg2, imgImg4, imgImg6, imgGrad2, imgImg1, imgImg5, imgImg3, imgImg7, imgImg8];
  const row2imgs = [imgImg8, imgImg3, imgGrad3, imgImg6, imgImg1, imgImg7, imgImg4, imgImg, imgImg5, imgImg2];
  const row1 = [...row1imgs, ...row1imgs];
  const row2 = [...row2imgs, ...row2imgs];
  return (
    <div className="absolute left-[calc(50%-50vw)] top-[230px] w-[100vw] overflow-hidden flex flex-col gap-[20px]">
      <style>{`
        @keyframes lab-ltr {
...
function Section3() {
  const { ref, visible } = useScrollAnim();
  return (
    <div ref={ref} className="relative h-auto left-0 w-full min-h-[650px]" data-name="Section">
...
function Container43() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[124px] items-start left-[32px] top-[20px] w-[1037px]" data-name="Container">
      <Container44 />
      <H8 />
      <P15 />
    </div>
